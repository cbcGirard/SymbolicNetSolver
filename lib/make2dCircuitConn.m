function [M, v, Mix, Miy]=make2dCircuitConn(nX,vLoc)
...
v=zeros(nMat,1);
v(end)=1;
[Mix,Miy]=make2dReconMat(nX,vLoc);
...
diagVals=[-ones(nMat,1) offDiags' 4*ones(nMat,1) circshift(offDiags,1)', -ones(nMat,1)];
